...
const serveConfig = {
    rewrites: [
    {
        "source": "/curation-detail/:id",
        "destination": "/curation-detail/next-static-fallback.html"
    },
    {
        "source": "/magazine-detail/:id",
        "destination": "/magazine-detail/next-static-fallback.html"
    },
    {
        "source": "/studio-detail/:id",
        "destination": "/studio-detail/next-static-fallback.html"
    },
    {
        "source": "/wedding-hall-detail/:id",
        "destination": "/wedding-hall-detail/next-static-fallback.html"
    }
],
};
