      ...
      <div className="pt-20">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 py-8">
          ...
          {(studio.shooting_styles ||
            studio.studio_type ||
            studio.scene_types) && (
            <div id="studio-info" className="mt-8 scroll-mt-24">
          ...
          {packages && packages.length > 0 && (
            <div id="packages" className="mt-8 scroll-mt-24">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">
                촬영 패키지
              </h2>
                ...
                <div className="mb-4">
                  ...
                  {(studio.subway_line || studio.subway_name) && (
                    <div className="flex items-start gap-2 ml-7 mt-2">
                      ...
                      <p className="text-sm text-gray-600">
                        {studio.subway_line && `${studio.subway_line} `}
                        {studio.subway_name}
                        {studio.way_text && ` - ${studio.way_text}`}
                      </p>
                    </div>
                  )}
                  ...
                  {studio.business_hours && (
                    <div className="flex items-start gap-2 ml-7 mt-2">
                      ...
                      <p className="text-sm text-gray-600">
                        영업시간: {studio.business_hours}
                        {studio.holiday && ` (휴무: ${studio.holiday})`}
                      </p>
                    </div>
                  )}
                </div>
