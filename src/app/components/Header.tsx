    ...
    >
      <div className="w-full py-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center left-60 absolute z-10">
            {/* SERENADE logo using logo.svg with CSS filter */}
            <button
              onClick={scrollToTop}
          ...
          <div className="absolute right-60 z-10">
            <a
              ...
              className="bg-black w-fit text-white px-5 py-2 rounded-4xl text-md font-medium flex items-center space-x-2 hover:bg-[#FB6541] transition-colors duration-300"
            >
              {/* iOS App Store Icon */}
